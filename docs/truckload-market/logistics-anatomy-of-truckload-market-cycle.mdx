...
We’ve explained the basic market dynamics that drive the market cycle, let’s break one down, step-by-step.
...
The blue line is an index that a broker, Coyote Logistics, uses to get a sense of how the freight market is. A lot of big brokers are now using data to get better at pricing both to shippers and carriers.
