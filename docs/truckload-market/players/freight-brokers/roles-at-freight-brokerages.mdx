...
1. **Carrier sales**: [Carrier sales representatives](./what-are-carrier-sales/representatives.mdx) are responsible for representing the brokerage to carriers and negotiating rates and contracts with them. They may also be involved in identifying new carrier partners and building relationships with existing carriers.
