...
A freight agent is a person or company that works with a third-party logistics provider (3PL) or a [freight forwarding](../../../ocean-shipping/what-is-a-freight-forwarder.mdx) company to handle the logistics and transportation of goods for [shippers](../shippers/what-are-shippers-in-logistics.mdx). The freight agent acts as a sales representative for the 3PL or freight forwarding company, and is responsible for finding and securing business from shippers. The freight agent typically works on a commission basis and does not own or operate any transportation equipment.
