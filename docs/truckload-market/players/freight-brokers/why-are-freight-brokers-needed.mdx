...
[Freight brokers](./what-are-freight-brokers.mdx) are needed because they provide a valuable service to both [shippers](../shippers/what-are-shippers-in-logistics.mdx) and [carriers](../carriers/what-are-carriers-in-trucking.mdx) by facilitating the movement of goods and helping to coordinate the logistics of transportation. There are several reasons why freight brokers are needed:
...
5. Technology: Freight brokers typically understand the [different technologies used in logistics](../../../software/types-of-software.mdx) and often help shippers with implementation of technologies such as a [TMS](../../../software/what-is-a-tms.mdx).
